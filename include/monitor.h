...
void monitor_init()
{
    ...
    if (outpath) {
        ...
        monitor_buffer =
            malloc(sizeof(char) * (monitor_buffer_size + 1000));
...
void _monitor_buffer_vwrite(char *line, va_list args)
{
    ...
    monitor_buffer_position +=
        snprintf(monitor_buffer + monitor_buffer_position,
                 monitor_buffer_size - monitor_buffer_position, "%ld,",
                 nsec_elapsed);
    if ((monitor_buffer_position +=
         vsnprintf(monitor_buffer + monitor_buffer_position,
                   monitor_buffer_size - monitor_buffer_position, line,
                   args)) < 0) {
